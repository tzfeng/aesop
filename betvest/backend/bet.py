...
# figure out betting duration
# don't need win condition, create another class with data read in and stock prices compared to generate bool
...
class Bet:
    ...
    def timed_payout(self, current_price: float):
        sleep_time = self.voting_period()
        time.sleep(sleep_time)
        self.payout(current_price)
